...
#     Consider using the unified model optimizers with gradient-based methods instead.
...
class LargeDomainEmulator:
    ...
    def __init__(self, config: Dict[str, Any], logger: logging.Logger):
        ...
        .. deprecated::
            LargeDomainEmulator is deprecated and will be removed in a future version.
            Consider using the unified model optimizers with gradient-based methods
            (run_adam, run_lbfgs) instead.
        """
        warnings.warn(
            "LargeDomainEmulator is deprecated and will be removed in a future version. "
            "Consider using the unified model optimizers (SUMMAModelOptimizer, FUSEModelOptimizer, "
            "NgenModelOptimizer) with gradient-based methods (run_adam, run_lbfgs) instead.",
            DeprecationWarning,
            stacklevel=2
        )
