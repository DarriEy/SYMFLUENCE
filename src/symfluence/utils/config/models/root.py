...
class SymfluenceConfig(BaseModel):
    ...
    def normalize_flat_config(cls, values):
        ...
        from symfluence.utils.config.transformers import FLAT_TO_NESTED_MAP, transform_flat_to_nested
    ...
    def _flattened_dict_cache(self) -> Dict[str, Any]:
        ...
        """
        from symfluence.utils.config.transformers import flatten_nested_config
    ...
    def __getattr__(self, name: str) -> Any:
        ...
        from symfluence.utils.config.transformers import FLAT_TO_NESTED_MAP
    ...
    def from_file(
        ...
        *,
        ...
        from symfluence.utils.config.factories import from_file_factory
    ...
    def from_preset(cls, preset_name: str, **overrides) -> 'SymfluenceConfig':
        ...
        """
        # Import here to avoid circular dependency
        from symfluence.utils.config.factories import from_preset_factory
    ...
    def from_minimal(
        ...
        **overrides
        ...
        """
        # Import here to avoid circular dependency
        from symfluence.utils.config.factories import from_minimal_factory
