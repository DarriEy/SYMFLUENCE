...
# Default calibration parameters for jFUSE (most sensitive parameters)
DEFAULT_CALIBRATION_PARAMS = [
    "S1_max",     # Upper storage capacity
    "S2_max",     # Lower storage capacity
    "ku",         # Upper layer drainage
    "ki",         # Interflow rate
    "ks",         # Baseflow rate
    "n",          # TOPMODEL decay parameter
    "v",          # Linear baseflow rate
    "Ac_max",     # Max saturated area fraction
    "T_melt",     # Snowmelt threshold temperature (if snow enabled)
    "melt_rate",  # Degree-day snowmelt factor (if snow enabled)
]
...
class JFUSEConfig(BaseModel):
    ...
    # =========================================================================
    model_config_name: Literal['prms', 'sacramento', 'topmodel', 'vic'] = Field(
        default='prms',
        description="jFUSE model structure. Each structure has different process representations."
    )
    ...
    params_to_calibrate: str = Field(
        default='S1_max,S2_max,ku,ki,ks,n,v,Ac_max,T_melt,melt_rate',
...
class JFUSEConfigAdapter(AutoGeneratedConfigAdapter):
    ...
    def get_defaults(cls) -> Dict[str, Any]:
        ...
        return {
            ...
            'JFUSE_USE_GPU': False,
            'JFUSE_PARAMS_TO_CALIBRATE': 'S1_max,S2_max,ku,ki,ks,n,v,Ac_max,T_melt,melt_rate',
