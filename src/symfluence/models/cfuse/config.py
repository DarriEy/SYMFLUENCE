...
# Default calibration parameters for cFUSE (most sensitive parameters)
DEFAULT_CALIBRATION_PARAMS = [
    ...
    "melt_rate",  # Degree-day snowmelt factor
]
...
class CFUSEConfig(BaseModel):
    ...
    model_structure: Literal['prms', 'sacramento', 'topmodel', 'vic', 'arno'] = Field(
        default='vic',
        description="cFUSE model structure preset. Each structure has different process representations."
    )
...
class CFUSEConfigAdapter(AutoGeneratedConfigAdapter):
    ...
    def get_defaults(cls) -> Dict[str, Any]:
        ...
        return {
            ...
            'CFUSE_DEVICE': 'cpu',
            'CFUSE_PARAMS_TO_CALIBRATE': 'S1_max,S2_max,ku,ki,ks,n,v,Ac_max,T_melt,melt_rate',
