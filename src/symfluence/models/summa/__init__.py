...
Key Components:
    ...
    SummaRunner: Model execution with SLURM or local GRU-parallel support
...
Configuration Parameters:
    ...
    SETTINGS_SUMMA_PARALLEL_BACKEND: GRU-parallel backend (default: 'slurm')
...
Limitations and Considerations:
    ...
    - Large domains benefit from SUMMA GRU-parallel execution
