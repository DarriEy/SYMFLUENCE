...
CF_STANDARD_NAMES: Dict[str, Dict[str, str]] = {
    # --- Forcing variables ---
    'airpres':    {'standard_name': 'air_pressure',
                   'units': 'Pa',
    ...
    'pptrate':    {'standard_name': 'precipitation_flux',
                   'units': 'kg m-2 s-1',
                   'long_name': 'precipitation rate'},
    'windspd':    {'standard_name': 'wind_speed',
                   'units': 'm s-1',
                   'long_name': 'wind speed at measurement height'},
    'spechum':    {'standard_name': 'specific_humidity',
                   'units': 'kg kg-1',
                   'long_name': 'specific humidity'},
    'relhum':     {'standard_name': 'relative_humidity',
                   'units': '%',
                   'long_name': 'relative humidity'},
    'SWRadAtm':   {'standard_name': 'surface_downwelling_shortwave_flux_in_air',
                   'units': 'W m-2',
                   'long_name': 'downward shortwave radiation at the surface'},
    'LWRadAtm':   {'standard_name': 'surface_downwelling_longwave_flux_in_air',
                   'units': 'W m-2',
                   'long_name': 'downward longwave radiation at the surface'},

    # --- CFIF variable names (aliases) ---
