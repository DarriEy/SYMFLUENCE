...
class TestAutoGeneratedMapping:
    ...
    def test_auto_generated_matches_manual(self):
        ...
        known_extra = {
            ...
            'PIHM_TIMEOUT',
            # HydroGeoSphere model configuration keys
            'HGS_INSTALL_PATH', 'HGS_EXE', 'HGS_GROK_EXE',
            'SETTINGS_HGS_PATH', 'HGS_SPATIAL_MODE', 'HGS_K_SAT',
            'HGS_POROSITY', 'HGS_VG_ALPHA', 'HGS_VG_N', 'HGS_VG_SRES',
            'HGS_SS', 'HGS_MANNINGS_N', 'HGS_SOIL_DEPTH',
            'HGS_DOMAIN_WIDTH', 'HGS_COUPLING_SOURCE',
            'HGS_RECHARGE_VARIABLE', 'HGS_SOLVER_MAX_ITERATIONS',
            'HGS_TIMESTEP_SECONDS', 'EXPERIMENT_OUTPUT_HGS',
            'HGS_PARAMS_TO_CALIBRATE', 'HGS_TIMEOUT',
