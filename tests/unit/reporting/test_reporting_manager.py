...
class TestReportingManager:
    ...
    def test_init(self, mock_config, mock_logger):
        ...
        assert manager._plot_config is None
        assert manager._data_processor is None
        assert manager._spatial_processor is None
    ...
    def test_visualization_disabled(self, mock_config, mock_logger, mock_domain_plotter):
        ...
        domain_instance.plot_domain.assert_not_called()
        domain_instance.plot_discretized_domain.assert_not_called()
